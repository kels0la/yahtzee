    ...
    switch (props.disabledRadio) {
      case `onesDisabled`:
        ...
        rowThreeDisplay =
          <RadioButton
            id={id}
            disabledScore={disabledScores.ones}
            toggleHidden={disabledScores.onesHidden} radioBtnValue={radioBtnValue}
            displayedValue={displayedValues.ones}
            disabledRadio={props.disabledRadio}
            handleChange={props.handleRadioButtonSelection}
            theme={theme}
          />;
        break;
      case `twosDisabled`:
        ...
        rowThreeDisplay =
          <RadioButton
            id={id}
            disabledScore={disabledScores.twos}
            toggleHidden={disabledScores.twosHidden} radioBtnValue={radioBtnValue}
            displayedValue={displayedValues.twos}
            disabledRadio={props.disabledRadio}
            handleChange={props.handleRadioButtonSelection}
            theme={theme}
          />;
      ...
      case `threesDisabled`:
        ...
        rowThreeDisplay =
          <RadioButton
            id={id}
            disabledScore={disabledScores.threes}
            toggleHidden={disabledScores.threesHidden} radioBtnValue={radioBtnValue}
            displayedValue={displayedValues.threes}
            disabledRadio={props.disabledRadio}
            handleChange={props.handleRadioButtonSelection}
            theme={theme}
          />;
      ...
      case `foursDisabled`:
        ...
        rowThreeDisplay =
          <RadioButton
            id={id}
            disabledScore={disabledScores.fours}
            toggleHidden={disabledScores.foursHidden} radioBtnValue={radioBtnValue}
            displayedValue={displayedValues.fours}
            disabledRadio={props.disabledRadio}
            handleChange={props.handleRadioButtonSelection}
            theme={theme}
          />;
      ...
      case `fivesDisabled`:
        ...
        rowThreeDisplay =
          <RadioButton id={id}
            disabledScore={disabledScores.fives}
            toggleHidden={disabledScores.fivesHidden} radioBtnValue={radioBtnValue}
            displayedValue={displayedValues.fives}
            disabledRadio={props.disabledRadio}
            handleChange={props.handleRadioButtonSelection}
            theme={theme}
          />;
      ...
      case `sixesDisabled`:
        ...
        rowThreeDisplay =
          <RadioButton
            id={id}
            disabledScore={disabledScores.sixes}
            toggleHidden={disabledScores.sixesHidden} radioBtnValue={radioBtnValue}
            displayedValue={displayedValues.sixes}
            disabledRadio={props.disabledRadio}
            handleChange={props.handleRadioButtonSelection}
            theme={theme}
          />;
      ...
      case `threeKindDisabled`:
        ...
        rowThreeDisplay =
          <RadioButton
            id={id}
            disabledScore={disabledScores.threeKind}
            toggleHidden={disabledScores.threeKindHidden} radioBtnValue={radioBtnValue}
            displayedValue={displayedValues.threeKind}
            disabledRadio={props.disabledRadio}
            handleChange={props.handleRadioButtonSelection}
            theme={theme}
          />;
      ...
      case `fourKindDisabled`:
        ...
        rowThreeDisplay =
          <RadioButton
            id={id}
            disabledScore={disabledScores.fourKind}
            toggleHidden={disabledScores.fourKindHidden} radioBtnValue={radioBtnValue}
            displayedValue={displayedValues.fourKind}
            disabledRadio={props.disabledRadio}
            handleChange={props.handleRadioButtonSelection}
            theme={theme}
          />;
      ...
      case `fullHouseDisabled`:
        ...
        rowThreeDisplay =
          <RadioButton id={id}
            disabledScore={disabledScores.fullHouse}
            toggleHidden={disabledScores.fullHouseHidden} radioBtnValue={radioBtnValue}
            displayedValue={displayedValues.fullHouse}
            disabledRadio={props.disabledRadio}
            handleChange={props.handleRadioButtonSelection}
            theme={theme}
          />;
      ...
      case `smallStraightDisabled`:
        ...
        rowThreeDisplay =
          <RadioButton id={id}
            disabledScore={disabledScores.smallStraight}
            toggleHidden={disabledScores.smallStraightHidden} radioBtnValue={radioBtnValue}
            displayedValue={displayedValues.smallStraight}
            disabledRadio={props.disabledRadio}
            handleChange={props.handleRadioButtonSelection}
            theme={theme}
          />;
      ...
      case `largeStraightDisabled`:
        ...
        rowThreeDisplay =
          <RadioButton
            id={id}
            disabledScore={disabledScores.largeStraight}
            toggleHidden={disabledScores.largeStraightHidden} radioBtnValue={radioBtnValue}
            displayedValue={displayedValues.largeStraight}
            disabledRadio={props.disabledRadio}
            handleChange={props.handleRadioButtonSelection}
            theme={theme}
          />;
      ...
      case `yahtzeeDisabled`:
        ...
        rowThreeDisplay =
          <RadioButton id={id}
            disabledScore={disabledScores.yahtzee}
            toggleHidden={disabledScores.yahtzeeHidden} radioBtnValue={radioBtnValue}
            displayedValue={displayedValues.yahtzee}
            disabledRadio={props.disabledRadio}
            handleChange={props.handleRadioButtonSelection}
            theme={theme}
          />;
      ...
      case `chanceDisabled`:
        ...
        rowThreeDisplay =
          <RadioButton
            id={id}
            disabledScore={disabledScores.chance}
            toggleHidden={disabledScores.chanceHidden}
            radioBtnValue={radioBtnValue}
            displayedValue={displayedValues.chance}
            disabledRadio={props.disabledRadio}
            handleChange={props.handleRadioButtonSelection}
            theme={theme}
          />;
