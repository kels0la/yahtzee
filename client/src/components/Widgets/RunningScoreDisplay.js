    ...
    <React.Fragment>
      <div className={`mt-10 ml-3`}>
        <div className={`p-2 ${theme.shadowEffect} rounded-lg`}>
          <div className={`pt-2 pb-1 px-2 rounded ${theme.cardBackground} ${theme.shadowEffect} ${theme.standardBorder} border`}>
        ...
        <div className={`p-2 ${theme.shadowEffect} rounded-lg mt-3`}>
          <div className={`pt-2 pb-1 px-2 rounded ${theme.cardBackground} ${theme.shadowEffect} ${theme.standardBorder} border`}>
            ...
            <hr className={`${theme.specialBorder} border outsetBorder mb-3`}></hr>
            <p className={`mb-2 ${theme.standardText}`}><span className={`${theme.specialText}`}>To start:</span> Click the Roll Dice Button to begin your turn. There are three dice rolls per turn.</p>
            <p className={`mb-2 ${theme.standardText}`}><span className={`${theme.specialText}`}>To hold dice for next roll:</span> Click on them. If the shadow is green, they’re held. If the shadow is red, they’re not.</p>
            <p className={`mb-2 ${theme.standardText}`}><span className={`${theme.specialText}`}>To take score:</span> Select the proper radio button within the “Select" column and click the “Take Score” button afterwards.</p>
