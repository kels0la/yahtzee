    ...
    <ThemeContext.Consumer>
      ...
      <React.Fragment>
        <div onClick={(event) => handleBackgroundClick(event)} className='overlaytwo'>
          ...
          <div className={`w-2/3 ${theme.navBackground} p-3 border ml-auto mr-auto ${theme.standardBorder} max-h-full overflow-x-auto ${theme.shadowEffect} top-auto rounded-lg -mt-8 z-10 mb-8`}>
            <i onClick={(event)=>props.closeHowToPlayModal(event)} className={`fas fa-times float-right cursor-pointer -mt-1 ${theme.purchaseText}`}></i>
            <h1 className='text-center clearfix'>How to Play <span className={`${theme.purchaseText}`}>Yahtzee</span></h1>
            ...
            <h5 className={`${theme.purchaseText} underline mt-3`}>Ones, Twos, Threes, Fours, Fives, Sixes</h5>
            ...
            <h5 className={`${theme.purchaseText} underline`}>Three-of-a-kind</h5>
            ...
            <h5 className={`${theme.purchaseText} underline`}>Four-of-a-kind</h5>
            ...
            <h5 className={`${theme.purchaseText} underline`}>Full House</h5>
            ...
            <h5 className={`${theme.purchaseText} underline`}>Small Straight</h5>
            ...
            <h5 className={`${theme.purchaseText} underline`}>Large Straight</h5>
            ...
            <h5 className={`${theme.purchaseText} underline`}>YAHTZEE!</h5>
            ...
            <h5 className={`${theme.purchaseText} underline`}>Chance</h5>
              <p className='mt-2 mb-2'>Chance does not require any specific combination of dice. Chance is calculated as the sum of all dice.</p>
